...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"js/triVille.js":[function(require,module,exports) {
"use strict";
...
document.querySelector("#read-button").addEventListener('click', function () {
  ...
  reader.addEventListener('load', function (e) {
    ...
    listVille.forEach(function (ville) {
...
function getArrayCsv(csv) {
  ...
  listLine.forEach(function (line) {
    if (isFirstLine || line === '') {
      ...
      var listColumn = line.split(";");
      listVille.push(new Ville(listColumn[8], listColumn[9], listColumn[11], listColumn[12], listColumn[13], 0));
    }
  });
  return listVille.filter(function (v) {
...
function distanceFromGrenoble(ville) {
  ...
  // Ville donnée
  var lon2 = ville.longitude;
  var lat2 = ville.latitude;
  if (parseFloat(lat1) != lat1 || parseFloat(lon1) != lon1 || parseFloat(lat2) != lat2 || parseFloat(lon1) != lon1) throw "Error params. Only float value accepted.";
  if (lat1 < 0 || lat1 > 90 || lat2 < 0 || lat2 > 90) throw "Error params. The params lat1 and lat2 must be 0< ? <90. Here lat1 = " + lat1 + " and lat2 = " + lat2;
  if (lon1 < -180 || lon1 > 180 || lon2 < -180 || lon2 > 180) throw "Error params. The params lon1 and lon2 must be -180< ? <180. Here lon1 = " + lon1 + " and lon2 = " + lon2;
  var a = Math.PI / 180;
  lat1 = lat1 * a;
  lat2 = lat2 * a;
  lon1 = lon1 * a;
  ...
  var laDistance = rad_dist * 3437.74677 * 1.1508 * 1.6093470878864446 * 1000;
  return laDistance;
}
function distanceRoute(ville) {
  ...
  var lat2 = 45.764043;
  var lon2 = 4.835659;
  var urlString = 'https://maps.googleapis.com/maps/api/distancematrix/json?origins=' + lat1 + '%2C' + lon1 + '&destinations=' + ville.latitude + '%2C' + ville.longitude + '&key=AIzaSyCnX7DC_Oq9WzadhndLamNoJjLWVgpHFJI';
...
function heapsort() {
  ...
  for (var _i = 0; _i < n; _i++) {
    ...
    var size = n - _i - 1; //new size after remove last
    listVille[size] = remove(listVille, size, _i); //put the largest at the end
  }
}
...
function heapify(a, size, i) {
  ...
  var larger;
  while (i < size / 2) {
    // from top down, swap with larger child
    var left = 2 * i + 1;
    var right = 2 * i + 2;
    if (right < size && a[right].distanceFromGrenoble > a[left].distanceFromGrenoble) larger = right;else larger = left;
    if (top >= a[larger].distanceFromGrenoble) break;
    swap(i, larger);
    i = larger;
  }
...
/** MODEL */
var Ville = /*#__PURE__*/_createClass(function Ville(nom_commune, codes_postaux, latitude, longitude, dist, distanceFromGrenoble) {
  _classCallCheck(this, Ville);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/triVille.js"], null)
//# sourceMappingURL=/triVille.82369faf.js.map